...
# $URL: svn://subversion.adept.local/ApplicationMonitor/src/trunk/ApplicationMonitor.WebApp/config/environments/production.rb $
...
ApplicationMonitorApp::Application.configure do
