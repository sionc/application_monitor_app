  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved system as @system" do
        ...
        post :create, {:system => { "guid" => "invalid value" }}, valid_session
        assigns(:system).should be_a_new(System)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested system" do
        ...
        System.any_instance.should_receive(:update_attributes).with({ "guid" => "MyString" })
        put :update, {:id => system.to_param, :system => { "guid" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the system as @system" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        System.any_instance.stub(:save).and_return(false)
        put :update, {:id => system.to_param, :system => { "guid" => "invalid value" }}, valid_session
        assigns(:system).should eq(system)
      end
